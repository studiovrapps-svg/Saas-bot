          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <div className="max-w-xl">
                  ...
                  <button onClick={async () => {
                      ...
                      if (!confirm('¿Estás seguro de enviar esta campaña? Esta acción no se puede deshacer.')) return;
                      
                      try {
                          const res = await fetch(`http://localhost:3000/api/tenant/${tenantId}/campaigns/send`, {
                              method: 'POST',
...
# Insert just before the end of the <div className="flex-1 overflow-y-auto...
# Let's just find the closing tag for SECCIÓN MENÚ RÍGIDO (Nivel 1)
code = code.replace("      {/* MODALES */}", campaign_view + "\n      {/* MODALES */}")

with open('bot-engine-frontend/src/App.jsx', 'w', encoding='utf-8') as f:
    f.write(code)
print("Campaign view inserted")
