                  ...
                  <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="flex-1">
                          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 h-full flex flex-col justify-center">
                              ...
                              <input type="text" id="campaignTemplateName" placeholder="Ej: promo_navidad_2026" className="w-full border border-gray-300 p-3 rounded-lg outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition mb-4 text-sm bg-white" />
                      ...
                      <div className="flex-[1.2]">
                          <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 h-full">
...
# Use regex to replace everything in between (inclusive of start, exclusive of end_str)
pattern = re.compile(re.escape(start_str) + r".*?(?=" + re.escape(end_str) + r")", re.DOTALL)
if pattern.search(code):
    code = pattern.sub(new_campaign_view + "\n", code)
