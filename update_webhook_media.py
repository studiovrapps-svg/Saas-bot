...
target = """              // Extraer el texto real que escribi el usuario (o el botn que presion)
              let user_message = ``;
...
if target in code:
    ...
    with open('bot-engine-backend/src/controllers/webhook.controller.js', 'w', encoding='utf-8') as f:
        f.write(code)
    print("webhook.controller.js updated with media handling.")
else:
    print("Target not found in webhook.controller.js.")
