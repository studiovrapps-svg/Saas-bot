...
broken_part = r'\}\)\} className="w-full border-b border-gray-200 p-2 mb-5 outline-none focus:border-black bg-transparent text-sm" placeholder="Ej: Pizza Familiar" />'
...
code = re.sub(broken_part, fixed_part, code)
